...
function createStudentRouter(repository) {
    ...
    router.put("/:id/guardian", async (req, res) => {
        try {
    ...
    router.delete("/:id/guardian", async (req, res) => {
        try {
            const studentId = parseInt(req.params.id);
    ...
    router.get("/:id/guardian", async (req, res) => {
        try {
            const studentId = parseInt(req.params.id);
    ...
    router.get("/:id/guardian/available", async (req, res) => {
        try {
            const studentId = parseInt(req.params.id);
